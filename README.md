...
- [Hire LouisDSC](#LouisDSC)

## Download/Install

- NPM: `npm install hover.css --save`
- Bower: `bower install hover --save`
- [Download Zip](https://github.com/LouisDSC/Hover_CSS.git)
...
Should your application enable end users to produce separate applications that incorporate Ian Lunn Design Limited's software, for example, a development toolkit, library, or application builder, you must obtain an OEM Commercial License. Please [contact us](https://louis-japheth-kouassi.web.app/) for more information about the OEM Commercial License.

## Hire Ian Lunn

[Ian Lunn](https://louis-japheth-kouassi.web.app/) is a Freelance Front-end Developer

Hire [Ian](https://louis-japheth-kouassi.web.app/) for responsive websites, WordPress websites, JavaScript, animation, and optimization.
